...
> [!WARNING]
> **DEPRECATED:** The `splunk_python_sdk` utility and its related inputs are deprecated and will be removed in v5. Please plan to migrate to the new dynamic library installation feature in v5.
