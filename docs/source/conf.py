...
# The master document (root document for the documentation)
root_doc = "index"
...
html_title = f"splunk-app-action v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/VatsalJagani/splunk-app-action",
            "html": """
