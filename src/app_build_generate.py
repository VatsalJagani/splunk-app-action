...
def file_folder_permission_changes():
    ...
    if to_make_permission_changes:
        # Permission Changes
        utils.execute_system_command("find . -type f -exec chmod 644 '{}' \\;")
        ...
        utils.execute_system_command("find . -type d -exec chmod 755 '{}' \\;")
...
def generate_build(app_build_dir_name, app_build_dir_path):
    ...
    utils.execute_system_command(f"mv {app_build_dir_name} {GlobalVariables.APP_PACKAGE_ID}")
