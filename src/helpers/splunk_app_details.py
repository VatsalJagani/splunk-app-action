...
def fetch_app_package_id_from_global_config_json(global_config_file_path):
    ...
    try:
        ...
        gat.error(f"Exception while fetching app_package_id from globalConfig.json file. exception={e}")
...
def fetch_app_version_from_global_config_json(global_config_file_path):
    ...
    try:
        ...
        gat.error(f"Exception while fetching app_version_number from globalConfig.json file. exception={e}")
