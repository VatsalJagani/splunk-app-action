...
class GlobalVariables:
    ...
    def initiate(app_dir_name, repodir_name=None, root_dir_path=None) -> None:
        ...
        GlobalVariables.ORIGINAL_REPO_DIR_PATH = os.path.join(
            GlobalVariables.ROOT_DIR_PATH, GlobalVariables.ORIGINAL_REPO_DIR_NAME
        )

        GlobalVariables.APP_DIR_NAME = app_dir_name
        GlobalVariables.ORIGINAL_APP_DIR_PATH = os.path.join(
            GlobalVariables.ORIGINAL_REPO_DIR_PATH, GlobalVariables.APP_DIR_NAME
        )
